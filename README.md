...
## v3.1.4 — kordoc 2.2.4 + 문서 파싱 엔진 강화

- **kordoc 2.2.4** — 별표/별지서식 파싱 엔진 업그레이드. 병합 셀 HTML `<table>` 출력, markdownToHwpx 서식 강화, 양식 자동 채우기(Form Filler) 지원.

<details>
<summary>v3.1.0~v3.1.3 변경 이력</summary>
...
- **kordoc 1.6 → 2.2.4** — 문서 파싱 엔진 업그레이드 (XLSX/DOCX 지원, 보안 강화, 양식 채우기)
